...
public class MarqueeTextView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mText = String.valueOf(typedArray.getText(R.styleable.MarqueeTextView_text));
        mTextColor = typedArray.getColor(R.styleable.MarqueeTextView_textColor, 0xffff0000);
        mTextSize = typedArray.getDimension(R.styleable.MarqueeTextView_textSize, 30f);
        isScroll = typedArray.getBoolean(R.styleable.MarqueeTextView_scroll, true);
