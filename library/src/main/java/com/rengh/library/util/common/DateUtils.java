...
public class DateUtils {
    ...
    public static String getDate(int day) {
        ...
        try {
            ...
            if (0 == day) {
                ...
                date = sdf.format(System.currentTimeMillis() + day * 24 * 60 * 60 * 1000);
            }
        } catch (Exception e) {
            LogUtils.i(TAG, "Exception: " + e.getMessage());
        }
    ...
    public static String getTomorrowDate() {
        ...
        try {
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault());
            date = sdf.format(System.currentTimeMillis() + 1 * 24 * 60 * 60 * 1000);
        } catch (Exception e) {
            LogUtils.i(TAG, "Exception: " + e.getMessage());
        }
        return date;
    ...
    public static String getTomorrowTime() {
        ...
        try {
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault());
            String now = sdf.format(System.currentTimeMillis() + 1 * 24 * 60 * 60 * 1000);
