 ...
 */
public class MarqueeAlwaysTextView extends View {
    ...
    public MarqueeAlwaysTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.MarqueeAlwaysTextView);
        mText = String.valueOf(typedArray.getText(R.styleable.MarqueeAlwaysTextView_text));
        mTextColor = typedArray.getColor(R.styleable.MarqueeAlwaysTextView_textColor, 0xffff0000);
        mTextSize = typedArray.getDimension(R.styleable.MarqueeAlwaysTextView_textSize, 30f);
        isScroll = typedArray.getBoolean(R.styleable.MarqueeAlwaysTextView_scroll, true);
